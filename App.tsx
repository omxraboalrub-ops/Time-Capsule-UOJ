    ...
    <>
      ...
      <div className="relative z-10 min-h-screen bg-gradient-to-br from-indigo-950/90 via-slate-900/90 to-purple-950/90 flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8 transition-colors duration-500">
        <header className="w-full max-w-4xl mx-auto text-center mb-8">
              <h1 className="font-lora text-4xl sm:text-5xl font-bold text-indigo-200">FutureMe Time Capsule</h1>
              <p className="mt-3 text-lg text-indigo-400">A message to your future self awaits.</p>
          </header>
        ...
        <footer className="w-full max-w-4xl mx-auto text-center mt-12">
          <p className="text-sm text-indigo-500">&copy; {new Date().getFullYear()} FutureMe Project. All Rights Reserved.</p>
          <button 
              onClick={() => setShowEmbedModal(true)} 
              className="mt-2 text-sm text-indigo-400 hover:text-indigo-200 underline transition-colors"
            >
              Embed on your site
            </button>
        </footer>
